...
# Now the resultant output of the previous stage is XOR-ed with the corresponding round key. Here, the 16 bytes is
# not considered as a grid but just as 128 bits of data.
